...
tarteaucitron.services.xiti_smarttag = {
    ...
    "needConsent": false,
	"description": "Permet de mesurer l'audience du site et de produire des données statistiques anonymes.(durée de conservation 13 mois)",
...
// Jplatform 10 /////
tarteaucitron.services.jplatform = {
	"key": "jplatform",
	"type": "analytic",
	"name": "Jplatform",
	"uri": "https://www.jalios.com/jcms/alr_7284/fr/mentions-legales",
	"needConsent": false,
	"description": "Permet de gérer la session de l'utilisateur et ses préférences.(durée de conservation 1 an)",
	"cookies": ["JSESSIONID","jcms.prefs",'memberId'],
	"js": function () {
	}
};

// HAS /////
tarteaucitron.services.hascookie = {
	"key": "hascookie",
	"type": "api",
	"name": "Has_cookie",
	"uri": "https://www.has-sante.fr/portail/jcms/c_518191/fr/mentions-legales",
	"needConsent": false,
	"description": "Permet de gérer les abonnements aux newsletters et alertes emails, les recherches sauvegardées, dossier enregistré et panier de publications. (durée de conservation 1 an)",
    "cookies": ['cibleChoiced','userSelection','userSelectionEtab','saveSearch','emailClientHas'],
	"js": function () {
	}
};