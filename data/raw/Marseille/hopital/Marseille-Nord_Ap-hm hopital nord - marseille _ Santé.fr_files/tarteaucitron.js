          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                if (tarteaucitron.reloadThePage) {
                    html += '<button type="button" id="tarteaucitronBack" aria-label="' + tarteaucitron.lang.close + ' (' + tarteaucitron.lang.reload + ')" title="' + tarteaucitron.lang.close + ' (' + tarteaucitron.lang.reload + ')" class="sr-only">Fermer</button>';
                } else {
                    html += '<button type="button" id="tarteaucitronBack" aria-label="' + tarteaucitron.lang.close + '" title="' + tarteaucitron.lang.close + '" class="sr-only">Fermer</button>';
                }
    ...
    "addService": function (serviceId) {
        ...
        if (tarteaucitron.added[service.key] !== true) {
            ...
            if (service.description) {
              html += '       <span class="tarteaucitronListCookies">' + service.description + '</span><br/>';
            }
            ...
            if (tarteaucitron.parameters.moreInfoLink == true) {
                ...
                if (service.uri !== undefined && service.uri !== '') {
